(async function(){
'use strict';
var TOKEN=window._sbToken||localStorage.getItem('sb_gh_token');
if(!TOKEN){
  var e=document.createElement('div');
  e.style.cssText='position:fixed;top:20px;right:20px;background:#e74c3c;color:white;padding:16px 24px;border-radius:12px;z-index:99999;font-size:14px;min-width:200px;box-shadow:0 4px 20px rgba(0,0,0,.3);';
  e.textContent='❌ トークン未設定。再度ブックマークをタップしてください。';
  document.body.appendChild(e);
  setTimeout(function(){e.remove();},5000);
  return;
}

var REPO='hana8730/salon-app',FILE='sb-sync.json',BRANCH='main',HANA='T000997646',DAYS=30;
